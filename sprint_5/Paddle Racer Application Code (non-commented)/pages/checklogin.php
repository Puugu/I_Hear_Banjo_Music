...
4/9/17
checklogin.php - basic login authentication
...
<?php
  ...
  $con = mysqli_connect("localhost", "root","") or die(mysql_error()); //Connect to server
	...
	$query = mysqli_query($con, "SELECT * from program_user WHERE username='$username'"); //Query the users table if there are matching rows equal to $username
