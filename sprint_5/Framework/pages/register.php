    ...
    <div class="container theme-showcase" role="main">
			...
			<div class="well">
               ...
               <form action="/action_page.php" id="registerform">
						<select id="registerform_raceselect" name="raceselect">
						  <option value="shit">Up Shit Creek</option>
						  <option value="freeze">Christmas Freeze Off</option>
						  <option value="egypt">Egyptian Trials</option>
						</select>
						
						<label for="fname">First Name</label>
						<input type="text" id="registerform_fname" name="fname" placeholder="Your First name..">

						<label for="lname">Last Name</label>
						<input type="text" id="registerform_lname" name="lname" placeholder="Your Last name..">

						<label for="dob">Date of Birth</label>
						<input type="text" id="registerform_dob" name="dob" placeholder="Enter DOB..">
						
						<label for="id">ID Number</label>
						<input type="text" id="registerform_id" name="id" placeholder="Your ID Number..">

						<label for="hometown">Hometown</label>
						<input type="text" id="registerform_hometown" name="hometown" placeholder="Enter Hometown..">
						
						<label for="addteam">Add Team</label>
						<input type="text" id="registerform_addteam" name="addteam" placeholder="Enter Team Name..">
						
						<input type="button" value="Add Team">
						
						<label for="team">Select Team</label>
						<select id="registerform_team" name="team">
						...
						<input type="text" id="registerform_addboat" name="addboat" placeholder="Boat Type..">
					  	<input type="button" value="Add Boat Type To List">
						
						<label for="boatselect">Available Boat Classes</label>
						<select id="registerform_boatselect" name="boatselect">
