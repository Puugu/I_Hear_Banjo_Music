			...
			<div class="well">
               ...
               <table class="table table-striped">
					...
					<form action="/action_page.php" id="addracerform">
						...
						<input type="text" id="addracerform_fname" name="fname" placeholder="Your First name..">

						<label for="lname">Last Name</label>
						<input type="text" id="addracerform_lname" name="lname" placeholder="Your Last name..">

						<label for="dob">Date of Birth</label>
						<input type="text" id="addracerform_dob" name="dob" placeholder="Enter DOB..">
						
						<label for="id">ID Number</label>
						<input type="text" id="addracerform_id" name="id" placeholder="Your ID Number..">
